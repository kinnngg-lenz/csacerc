    ...
    <div class="container-fluid">
        <div class="row">
            <div class="jumbotron text-center">
                <h3>Your Conversation with {{ link_to_route('users.profile.show',$recuser->name,$recuser->username,['class' => 'text-info']) }}</h3>
            </div>
        <div class="container">
            <br style="clear:both">
            {{ Form::open() }}
            <div class="col-md-8 col-md-offset-2 form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                ...
                <span class="help-block pull-right"><p id="characterLeft" class="nomargin help-block ">You have reached the limit</p></span>
        ...
        <div class="container" style="margin-bottom:30px;margin-top:20px;">
            ...
            @empty
                <div class="well col-md-8 col-md-offset-2">
                    <h4 class="text-danger text-center"><i>Its feels lonely! Send a message now to start conversation with {{ $recuser->name }}</i></h4>
                </div>
            @endforelse
        </div>
    </div>
