    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="jumbotron text-center">
                ...
                <p class="">These are questions that you asked to someone</p>
                ...
                @forelse($questions as $question)
                    <div class="panel col-md-11">
                        ...
                        <p class="blockquote-reverse">
                            <span class="text-small">{{ link_to_route('questions.show', $question->created_at->diffForHumans(), $question->slug) }}
                                <br></span>
                            <span class="text-small"><b>Visible to public: </b>{{ $question->public==1 ? 'Yes' : 'No' }}</span>
                            <br><span class="text-small"><b>Asked
                                    To: </b>{{ $question->askedTo()->name==null ? "Everybody" : link_to_route('users.profile.show',$question->askedTo()->name,$question->askedTo()->username) }}</span>
                            <br><span
                                    class="text-small"><b>Approved: </b>{{ $question->approved ? "Yes" : "No" }}</span>
                        </p>
                    </div>
                @empty
                    Empty
