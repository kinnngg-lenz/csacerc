...
class UsersController extends Controller
{
    ...
    {
        $query = $request->get('q');
        $users = User::where('username', 'like', '%' . $query . '%')->orWhere('name', 'like', '%' . $query . '%')->orWhere('email', 'like', '%' . $query . '%')->orderBy('photo_id','DESC')->oldest()->paginate(10);
        $aluminis = Alumini::where('speaker', 'like', '%' . $query . '%')->orWhere('batch', 'like', '%' . $query . '%')->orWhere('profession', 'like', '%' . $query . '%')->orWhere('email', 'like', '%' . $query . "%")->orderBy('photo_id','DESC')->oldest()->paginate(10);
